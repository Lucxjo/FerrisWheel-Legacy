...
import me.turtlecode.ferriswheel.R.id.sendImageView
...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirestoreUtil.getOrCreateChatChannel(otherUserID, this) {channelID ->
            ...
            sendImageView.onClick {
                val messageToSend =
                        TextMessage(editTextMessage.text.toString(), Calendar.getInstance().time,
                                FirebaseAuth.getInstance().currentUser!!.uid, otherUserID, currentUser.dName)
